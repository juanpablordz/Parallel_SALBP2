...
${OBJECTDIR}/Activity.o: Activity.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Activity.o Activity.cpp

${OBJECTDIR}/ActivityCandidateStations.o: ActivityCandidateStations.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF $@.d -o ${OBJECTDIR}/ActivityCandidateStations.o ActivityCandidateStations.cpp

${OBJECTDIR}/AllCandidateStations.o: AllCandidateStations.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF $@.d -o ${OBJECTDIR}/AllCandidateStations.o AllCandidateStations.cpp

${OBJECTDIR}/AssemblyLine.o: AssemblyLine.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF $@.d -o ${OBJECTDIR}/AssemblyLine.o AssemblyLine.cpp

${OBJECTDIR}/Balas.o: Balas.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Balas.o Balas.cpp

${OBJECTDIR}/BinaryMixer.o: BinaryMixer.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF $@.d -o ${OBJECTDIR}/BinaryMixer.o BinaryMixer.cpp

${OBJECTDIR}/BinaryRestriction.o: BinaryRestriction.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF $@.d -o ${OBJECTDIR}/BinaryRestriction.o BinaryRestriction.cpp

${OBJECTDIR}/Constant.o: Constant.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Constant.o Constant.cpp

${OBJECTDIR}/CoordinatesVariable.o: CoordinatesVariable.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF $@.d -o ${OBJECTDIR}/CoordinatesVariable.o CoordinatesVariable.cpp

${OBJECTDIR}/DurationNode.o: DurationNode.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF $@.d -o ${OBJECTDIR}/DurationNode.o DurationNode.cpp

${OBJECTDIR}/DurationTree.o: DurationTree.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF $@.d -o ${OBJECTDIR}/DurationTree.o DurationTree.cpp

${OBJECTDIR}/Equation.o: Equation.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Equation.o Equation.cpp

${OBJECTDIR}/FileReader.o: FileReader.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF $@.d -o ${OBJECTDIR}/FileReader.o FileReader.cpp

${OBJECTDIR}/Graph.o: Graph.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Graph.o Graph.cpp

${OBJECTDIR}/GraphCreator.o: GraphCreator.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF $@.d -o ${OBJECTDIR}/GraphCreator.o GraphCreator.cpp

${OBJECTDIR}/GroupFamilies.o: GroupFamilies.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF $@.d -o ${OBJECTDIR}/GroupFamilies.o GroupFamilies.cpp

${OBJECTDIR}/Heuristic.o: Heuristic.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Heuristic.o Heuristic.cpp

${OBJECTDIR}/InfoVariableAssignation.o: InfoVariableAssignation.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF $@.d -o ${OBJECTDIR}/InfoVariableAssignation.o InfoVariableAssignation.cpp

${OBJECTDIR}/Integrator.o: Integrator.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Integrator.o Integrator.cpp

${OBJECTDIR}/Mixer.o: Mixer.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Mixer.o Mixer.cpp
...
${OBJECTDIR}/NegRestriction.o: NegRestriction.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF $@.d -o ${OBJECTDIR}/NegRestriction.o NegRestriction.cpp

${OBJECTDIR}/PrecedenceRestriction.o: PrecedenceRestriction.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF $@.d -o ${OBJECTDIR}/PrecedenceRestriction.o PrecedenceRestriction.cpp

${OBJECTDIR}/RestrictionGenerator.o: RestrictionGenerator.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF $@.d -o ${OBJECTDIR}/RestrictionGenerator.o RestrictionGenerator.cpp

${OBJECTDIR}/Restrictions.o: Restrictions.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Restrictions.o Restrictions.cpp

${OBJECTDIR}/Simplifier.o: Simplifier.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Simplifier.o Simplifier.cpp
...
${OBJECTDIR}/VariableFamily.o: VariableFamily.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF $@.d -o ${OBJECTDIR}/VariableFamily.o VariableFamily.cpp

${OBJECTDIR}/VectorBR.o: VectorBR.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF $@.d -o ${OBJECTDIR}/VectorBR.o VectorBR.cpp
